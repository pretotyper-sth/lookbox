...
사진·URL·모바일 구매내역은 168px 스테이지와 CTA 아래 44px 안내 슬롯을 사용하고, PC 구매내역·바로 보기는 안내 슬롯을 포함한 212px 박스를 사용하도록 합계를 고정했다. 모바일 구매내역의 PC 로그인 조건은 아이콘 없이 CTA 아래에 넣고, 데모 CTA도 실제 서비스와 같은 「주문 내역 가져오기」로 보이게 했다.
