...
- [tryon-setup-from-mypage](tryon-setup-from-mypage.md) — 바로 보기: 대상 선택 행만큼 프사 스테이지를 144px로 줄여 사진·URL과 전체 높이 통일. tryon17은 gpt-image-1 high로 상의·하의를 자른 뒤 원본 실루엣에 붙인다. 실패는 일 3회
