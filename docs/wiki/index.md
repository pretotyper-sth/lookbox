...
- [look-img-flex-min](look-img-flex-min.md) — 착장 img는 절대배치. 서버가 2:3을 4:5로 패딩해 양옆 회색이 안 섞인다
...
- [model-look-toggle](model-look-toggle.md) — 착장은 canonical+옷 실물. 다리 늘림 없음. 4:5 패딩. 착장 병렬·컷아웃 위 물결
