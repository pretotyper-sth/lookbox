...
구매내역 탭 안내: PC는 「쇼핑몰을 고른 뒤 로그인 화면이 열려요.」, 모바일 웹은 「구매내역은 PC에서 불러올 수 있어요」와 비활성 CTA. 수집 목록은 「취소 / N개 담기」로 행동을 분명히 하고, 다른 소스 탭을 다녀와도 유지한다. 「다른 쇼핑몰」에서만 현재 구매내역을 비우고 몰 선택으로 돌아간다. 흐름은 [[order-import-webview]].
