...
구매내역 탭 안내: 「쇼핑몰을 누르면 바로 열어요.」 푸터: 「내역 확인 후 고른 옷만 옷장에 담아요.」 zip·「컴퓨터에서만」 잠금은 없다. 흐름은 [[order-import-webview]].
...
구매내역 탭은 옷장 추가 시트에 있다(사진·URL 옆). 몰을 누르면 `OrderImportSession`이 바로 뜬다.
