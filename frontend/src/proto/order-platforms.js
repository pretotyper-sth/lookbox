...
export const ORDER_PLATFORMS = [
  ...
  { id: '29cm',     name: '29CM',      host: '29cm.co.kr',      loginUrl: 'https://auth.29cm.co.kr/login',                ordersUrl: 'https://www.29cm.co.kr/order/my-order/list' },
  { id: 'zigzag',   name: '지그재그',   host: 'zigzag.kr',       loginUrl: 'https://zigzag.kr/login',                      ordersUrl: 'https://zigzag.kr/my-page' },
  { id: 'ably',     name: '에이블리',   host: 'a-bly.com',       loginUrl: 'https://m.a-bly.com/login',                    ordersUrl: 'https://mobile.a-bly.com/orders' },
  ...
  { id: 'naver',    name: '네이버페이', host: 'pay.naver.com',   loginUrl: 'https://nid.naver.com/nidlogin.login',         ordersUrl: 'https://pay.naver.com/pc/history?page=1' },
  ...
  { id: 'kream',    name: 'KREAM',      host: 'kream.co.kr',     loginUrl: 'https://kream.co.kr/login',                    ordersUrl: 'https://kream.co.kr/my/buying?tab=finished' },
  ...
  { id: 'musthave', name: '머스트잇',   host: 'mustit.co.kr',    loginUrl: 'https://mustit.co.kr/member/login',            ordersUrl: 'https://mustit.co.kr/m/mypage/my_buying' },
];
